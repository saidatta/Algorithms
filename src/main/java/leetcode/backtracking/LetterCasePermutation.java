...
//    is responsible for both generating permutations and adding them to the list. We can separate these
//    responsibilities
...
//    can achieve this by using interfaces and abstract classes.
    ...
    //    Dependency Inversion Principle: High-level modules should not depend on low-level modules. Both should
    //    depend on
